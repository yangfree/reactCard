// pages/treatment/addmedicine.js
const app = getApp();
...
/*
  medicinenameInput: function (e) {
    console.log("input medicine name")
    this.setData({
      searchtext: e.detail
    });
  },
*/
  bindaddmedicine: function(e) {
    var medicinedata = e.currentTarget.dataset.key
    var addmedicinedata = {
      id: medicinedata.id,
      medicine_name: medicinedata.officical_name,
      medicine_price: medicinedata.price,
      medicine_num: 1,
    }
    ...
    prevPage.setData({
      addmedicinedata: addmedicinedata
    })
    wx.navigateBack({
      delta: 2
    })
  ...
  onPullDownRefresh: function () {
    ...
    wx.getStorage({
      ...
      success: function (res) {
        console.log('token = ' + res.data);
        token = res.data;
        that.getmedicinelist(that.data.searchtext, token)
      },
      fail: function (res) {
        console.log('failed: ' + JSON.stringify(res));
      }
