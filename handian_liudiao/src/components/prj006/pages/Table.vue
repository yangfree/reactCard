<template>
  <section>
      ...
      <el-form :inline="true" :model="search">
        <el-row>
          <el-col>
            ...
            <el-form-item>
              <el-select v-model="search_check_status" placeholder="数据状态">
    ...
    >
      ...
      <el-table-column prop="a001" label="姓名"></el-table-column>
      <el-table-column prop="serial" label="编码"></el-table-column>
      <el-table-column prop="a003" label="患者所属医院"></el-table-column>
      <el-table-column prop="a011" label="住址"></el-table-column>
      <el-table-column prop="owner_name" label="录入人"></el-table-column>
