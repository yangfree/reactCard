<template>
  <div class="survey-form">
    <el-form ref="surveyForm" :model="infoForm" label-position="top">
      <!-- 表格内容开始 -->
      <!-- 若为内异症 -->
      <div v-if="hideOrShow.l001_l015==='0'? false: true">
        ...
        <el-form-item label="12、您都通过什么途径了解子宫内膜异位症？">
        ...
        <el-form-item label="14、您倾向于接受以下哪些治疗？">
      ...
      <div v-if="hideOrShow.l016_l027==='0'? false: true">
        <el-form-item label="1、您认为母亲有子宫腺肌病，女儿患子宫腺肌病的风险会增加吗? ">
          <el-radio v-model="infoForm.l016" label="1">有</el-radio>
          <el-radio v-model="infoForm.l016" label="2">没有</el-radio>
        ...
        <el-form-item label="9、您都通过什么途径了解子宫腺肌病？ ">
        ...
        <el-form-item label="11、您倾向于接受以下哪些治疗？ ">
      ...
      <div v-if="hideOrShow.l028_l046==='0'? false: true">
        ...
        <el-form-item label="16、您都通过什么途径了解子宫内膜异位症或子宫腺肌病? ">
        ...
        <el-form-item label="18、您倾向于接受以下哪些治疗? ">
    ...
    getSingleInfo() {
      apiGetPatientDataForm({
        ...
        .then((res) => {
          ...
          this.getHideCode(this.formName, this._id);
        })
        .catch((err) => {
          console.log(err);
        });
...
<style scoped>
.survey-form .el-form-item__label {
