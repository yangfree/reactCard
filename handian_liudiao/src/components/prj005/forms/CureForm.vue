  ...
  >
    <el-form ref="cureForm" :model="cureForm" label-width="160px" label-position="left">
      ...
      <el-form-item label="中药汤药服用疗程">
        ...
        <label>共服用</label>
        <!-- <el-input v-model="cureForm.drink_total" style="width: 250px;" placeholder="请输入整数类型的值"></el-input> -->
      ...
      <el-form-item label>
        ...
        <el-input v-model="cureForm.drink_name" style="width: 250px;"></el-input>
      </el-form-item>
      <el-form-item label>
        <label>已服用</label>
        <!-- <template slot="append">天/月</template> -->
        <!-- <el-input v-model="cureForm.drink_already" style="width: 250px;" placeholder="请输入整数类型的值"></el-input> -->
      ...
      <el-form-item label="中成药服用疗程">
        <label>共服用</label>
        <!-- <template slot="append">天/月/年</template> -->
        <!-- <el-input v-model="cureForm.drink_zc_total" style="width: 250px;" placeholder="请输入整数类型的值"></el-input> -->
        <el-input-number
          v-model="cureForm.drink_zc_total"
          :min="1"
          :precision="0"
          label="请输入整数类型的值"
        ></el-input-number>
      ...
      <el-form-item label>
        ...
        <el-input v-model="cureForm.drink_zc_name" style="width: 250px;"></el-input>
      </el-form-item>
      <el-form-item label>
        <label>已服用</label>
        <!-- <template slot="append">天/月</template> -->
        <!-- <el-input v-model="cureForm.drink_zc_already" style="width: 250px;" placeholder="请输入整数类型的值"></el-input> -->
        <el-input-number
      ...
      <el-form-item label="中医特色治疗疗程">
        ...
        <el-form-item label>
          ...
          <el-input v-model="cureForm.character_zc_name" style="width: 250px;"></el-input>
        </el-form-item>
        <el-form-item label>
          <label>已治疗</label>
          <!-- <template slot="append">天/月</template> -->
      ...
      <el-form-item label>
        ...
        <el-input v-model="cureForm.xi_kang_lc_type" style="width: 250px;"></el-input>
      </el-form-item>
      <el-form-item label>
        <label>预计给药</label>
      ...
      <el-form-item label>
        ...
        <el-input v-model="cureForm.injection_lc_kang" style="width: 250px;"></el-input>
      </el-form-item>
      <el-form-item label>
        <label>预计给药</label>
      ...
      <el-form-item label="抗生素口服给药具体药物">
        ...
        <p>
          ...
          <el-input
            v-show="cureForm['m_eat_mei']"
            v-model="cureForm.m_eat_mei_qita"
            placeholder="其他"
          ></el-input>
        </p>
        <p>
          ...
          <el-input
            v-show="cureForm['m_eat_nei']"
            v-model="cureForm.m_eat_nei_qita"
            placeholder="其他"
          ></el-input>
        </p>
        <p>
      ...
      <el-form-item label>
        ...
        <el-input v-model="cureForm.m_eat_lc_type" style="width: 250px;"></el-input>
      </el-form-item>
      <el-form-item label>
        <label>预计给药</label>
