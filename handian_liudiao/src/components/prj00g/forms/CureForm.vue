      ...
      <p></p>
        ...
        <el-form-item label="2、做过几次手术">
          ...
          <el-form-item label="10. 术后曾使用过哪些西药？">
            <el-tag type="danger" size="mini">多选</el-tag>
            <el-checkbox v-model="infoForm.i1001[0]">亮丙瑞林</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[1]">戈舍瑞林</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[2]">曲普瑞林</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[3]">抑那通</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[4]">米非司酮</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[5]">达那唑</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[6]">孕三烯酮</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[7]">醋酸甲羟孕酮</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[8]">醋酸甲地孕酮</el-checkbox>
            <el-checkbox v-model="infoForm.i1001[9]">其他</el-checkbox>
            <el-input v-model="infoForm.i1002"></el-input>
          </el-form-item>
  ...
  data() {
    return {
      infoForm: {
        ...
        i0902: "",
        i1001: [false,false,false,false,false,   false,false,false,false,false],
