  ...
  >
    ...
    >
      ...
      <el-form-item label="医院所属" prop="a0402">
        <el-radio v-model="patientInfo.a0402" label="1">三级医院</el-radio>
        <el-radio v-model="patientInfo.a0402" label="2">二级医院</el-radio>
        <el-radio v-model="patientInfo.a0402" label="3">一级医院</el-radio>
      </el-form-item>
...
<script>
import { apiAddPatient } from "@/api/api-prj00g";
export default {
  name: "AddPatient",
  data() {
    return {
